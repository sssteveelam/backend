...
exports.ApprovalModule = ApprovalModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [approval_service_1.ApprovalService, threshold_service_1.ThresholdService],
        exports: [approval_service_1.ApprovalService, threshold_service_1.ThresholdService],
    })
], ApprovalModule);
